...
export const PHASES: PhaseData[] = [
  ...
  },
  {
    ...
    progressStart: 0.42,
    progressEnd: 0.54,
    camera: { position: { x: -4.5, y: 5.4, z: -4 }, target: { x: 0, y: 4.8, z: 0 }, fov: 45 },
    atmosphere: {
      bgColor: '#071018',
      fogColor: '#071018',
      fogNear: 10,
    ...
    title: 'Los Labs',
    subtitle: 'IA + automatización trabajando',
  },
  {
    name: 'experiencia',
    progressStart: 0.54,
    progressEnd: 0.64,
    camera: { position: { x: 5, y: 4, z: 4 }, target: { x: 0, y: 3, z: 0 }, fov: 45 },
    atmosphere: {
      bgColor: '#14100c',
      fogColor: '#14100c',
      fogNear: 10,
    ...
    title: 'Tu negocio, digitalizado',
    subtitle: 'Landing · E-commerce · Automatización · UX/UI',
  },
  {
    name: 'tecnologia',
    progressStart: 0.64,
    progressEnd: 0.74,
    camera: { position: { x: 0, y: 6.35, z: 3.2 }, target: { x: 0, y: 6.15, z: -0.6 }, fov: 52 },
    atmosphere: {
      bgColor: '#0b100d',
      fogColor: '#0b100d',
      fogNear: 6,
